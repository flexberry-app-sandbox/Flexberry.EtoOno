...
CREATE TABLE [То] (
	 ...
	 [Это_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Это] (
	 ...
	 [Оно_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [То] ADD CONSTRAINT [То_FЭто_0] FOREIGN KEY ([Это_m0]) REFERENCES [Это]
CREATE INDEX То_IЭто_m0 on [То] ([Это_m0])

 ALTER TABLE [Это] ADD CONSTRAINT [Это_FОно_0] FOREIGN KEY ([Оно_m0]) REFERENCES [Оно]
CREATE INDEX Это_IОно_m0 on [Это] ([Оно_m0])
